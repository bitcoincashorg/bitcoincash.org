...
const Feature = ({featureTitle, featureBodyText, featureButtonText, featureIcon, featureImage, isReversed, btnHref, isDarkBg}) => {
...
<div 
  ...
  className={`${featureStyles.featureContainer} ${isReversed ? featureStyles.reverse : ""}`}>
    ...
    <div className={featureStyles.featureBodyContainer}>
        ...
        <PrimaryButton buttonText={featureButtonText} href={btnHref} noMarginLeft={true}></PrimaryButton>
        </div>
    </div>
    </div>
</div>)
