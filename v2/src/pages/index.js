...
import { EN_BANNER_ONE_TEXT, EN_BANNER_TWO_TEXT, EN_SUBSCRIBE_CTA_TEXT, EN_SUBSCRIBE_BTN_TEXT } from "../global/strings"
...
const IndexPage = () => {
  ...
  <Layout>
    ...
    <SingleButtonCTA text={EN_SUBSCRIBE_CTA_TEXT} btnText={EN_SUBSCRIBE_BTN_TEXT}></SingleButtonCTA>
    <SEO title="Home" />
  </Layout>)}
